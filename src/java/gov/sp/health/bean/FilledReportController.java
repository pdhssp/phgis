...
public class FilledReportController implements Serializable {
    ...
    public void loadMyAlerts(){
        String sql = "select f from FilledHealthForm where (f.area=:a1 or f.area.superArea=:a1 or f.area.superArea.superArea=:a1 or or f.area.superArea.superArea.superArea=:a1) ";
        Map m = new HashMap();
