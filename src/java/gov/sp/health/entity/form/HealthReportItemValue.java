 ...
 */
@Entity
public class HealthReportItemValue implements Serializable {
    ...
    private Long id;
    @ManyToOne
    private HealthFormItem investigationItem;
    private String name;
...
//Created Properties
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof HealthReportItemValue)) {
            return false;
        }
        HealthReportItemValue other = (HealthReportItemValue) object;
