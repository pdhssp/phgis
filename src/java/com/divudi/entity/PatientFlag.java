...
public class PatientFlag implements Serializable {
    ...
    @ManyToOne
    private HealthFormItemValueFlag investigationFlag;
//    @ManyToOne
//    private PatientItem patientItem;
    ...
    public HealthFormItemValueFlag getInvestigationFlag() {
        return investigationFlag;
    }

    public void setInvestigationFlag(HealthFormItemValueFlag investigationFlag) {
