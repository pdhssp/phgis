...
//                if (ii instanceof HealthFormItem && ii.getIxItemType() == InvestigationItemType.Value) {
...
//        cals = new ArrayList<InvestigationItem>();
        if (ix != null) {
            ...
            for (ReportItem ii : ix.getReportItems()) {
                ...
                if (ii instanceof HealthFormItem && ii.getIxItemType() == InvestigationItemType.Calculation) {
