...
import gov.sp.health.data.DepartmentType;
...
public  class PharmacyController implements Serializable {
    ...
    public List<Department> getSelectedItems() {
        selectedItems = getFacade().findBySQL("select c from Department c where c.retired=false and i.departmentType = com.divudi.data.DepartmentType.Pharmacy and upper(c.name) like '%" + getSelectText().toUpperCase() + "%' order by c.name");
    ...
    public List<Department> getItems() {
       // items = getFacade().findAll("name", true);
        String sql="SELECT i FROM Department i where i.retired=false and i.departmentType = com.divudi.data.DepartmentType.Pharmacy order by i.name";
    ...
    public static class DepartmentControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            PharmacyController controller = (PharmacyController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "pharmacyController");
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Department) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type "
                        + object.getClass().getName() + "; expected type: " + PharmacyController.class.getName());
            }
        }
    }
}
