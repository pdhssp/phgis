...
//    private BillEntry entry;
    ...
    public void settleBill() {
        ...
        if (getLstBillEntries().isEmpty()) {
            UtilityController.addErrorMessage("No services are added to the bill to settle");
            return;
        }
        ...
        if (patientTabId.equalsIgnoreCase("tabBht") || current.getCollectingCentre() != null) {
        ...
        if (paymentScheme.getPaymentMethod().toString().equals("Cheque")) {
        ...
        savePatient();
        getCurrent().setDeptId(getBillNumberBean().departmentBillNumberGenerator(getSessionController().getLoggedUser().getDepartment(), BillType.OpdBill));
        getCurrent().setInsId(getBillNumberBean().institutionBillNumberGenerator(getSessionController().getLoggedUser().getInstitution(), BillType.OpdBill));
    ...
    public List<Bill> getItems() {
        ...
        String sql = "SELECT i FROM Bill i where i.retired=false and i.billType = com.divudi.data.BillType.OpdBill ";
...
//    }
    ...
    public static class OpdBillControllerConverter implements Converter {

        public OpdBillControllerConverter() {
        }
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            BillController controller = (BillController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "opdBillController");
